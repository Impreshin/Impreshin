...
$sql = array(
	...
	"7"=>array(
		"CREATE TABLE IF NOT EXISTS `global_logs` (  `ID` int(6) NOT NULL AUTO_INCREMENT,  `app` varchar(3) DEFAULT NULL,  `datein` timestamp NULL DEFAULT CURRENT_TIMESTAMP,  `uID` int(6) DEFAULT NULL,  `label` varchar(100) DEFAULT NULL,  `section` varchar(50) DEFAULT NULL,  `log` text,  PRIMARY KEY (`ID`),  KEY `uID` (`uID`),  KEY `section` (`section`));"
	)
