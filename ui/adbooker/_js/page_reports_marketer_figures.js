...
var $combined = $("#combine-btn");
	...
	listRequest.push($.getJSON("/ab/data/reports/marketer_figures/_data", {"pubs":pubs,"years":years,"daterange":daterange,"combined":combined,"ID":marketerID}, function (data) {
		data = data['data'];
