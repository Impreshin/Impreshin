...
var $combined = $("#combine-btn");
	...
	listRequest.push($.getJSON("/ab/data/reports/marketer_targets/_data", {"pubs":pubs,"years":years,"daterange":daterange,"combined":combined,"ID":ID, "dID":dID, "order":order,"tolerance":tolerance}, function (data) {
		data = data['data'];
