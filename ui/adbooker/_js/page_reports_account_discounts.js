...
var $combined = $("#combine-btn");
	...
	listRequest.push($.getJSON("/ab/data/reports/account_discounts/_data", {"pubs":pubs,"years":years,"daterange":daterange,"combined":combined,"ID":selectID,"dir":dir,"dID":dID, "order":order}, function (data) {
		data = data['data'];
