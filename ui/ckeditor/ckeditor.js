...
(function () {
	...
	(function (a) {
		...
		a.equals = function (a) {
			try {return a && a.$ === this.$} catch (c) {return false}
		};
	...
	(function () {
		...
		var e = /^[\r\n\t ]+$/, f = CKEDITOR.dom.walker.bookmark(false, true), h = CKEDITOR.dom.walker.whitespaces(true), n = function (a) {
				return f(a) && h(a)
			};
	...
	(function () {
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({$: function (a) {
			...
			var c = CKEDITOR.env, g = "cke_" + this.id, e = CKEDITOR.tools.addFunction(function (b) {
				j && (a.unlockSelection(1), j = 0);
				d.execute(b)
			}, this), f = this, d = {id: g, combo: this, focus: function () {
	...
	(function () {
		var g, h = {modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function (a) {
			...
			c = 420;
			d = 80;
			try {var b = window.screen, e = Math.round(0.8 * b.width), c = Math.round(0.7 * b.height), d = Math.round(0.1 * b.width)} catch (h) {}
		...
		CKEDITOR.plugins.add("preview", {init: function (a) {
			a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && (g = this.path, a.addCommand("preview", h), a.ui.addButton && a.ui.addButton("Preview", {label: a.lang.preview.preview, command: "preview", toolbar: "document,40"}))
		}})
	})();
	...
	(function () {
		...
		var j = "", r = function () {
			...
			var e = CKEDITOR.plugins.undo.Image.prototype, f = "function" == typeof e.equalsContent ? "equalsContent" : "equals";
		...
		CKEDITOR.plugins.add("scayt", {requires: "menubutton,dialog", beforeInit: function (a) {
			...
			a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function (b, c) {
				...
				if (o("all", l) || o("ignoreall", l)) {
					p(a, "ignore_all", h.ignoreAll, "scayt_ignore_all", {exec: function () {
							f.ignoreAll(n)
						}}, "scayt_control", 3);
	...
	(function () {
		...
		var h = {editorFocus: !1, modes: {wysiwyg: 1, source: 1}}, g = {exec: function (c) {
