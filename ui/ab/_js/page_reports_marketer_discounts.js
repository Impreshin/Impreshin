...
var $combined = $("#combine-btn");
	...
	listRequest.push($.getJSON("/ab/data/reports/marketer_discounts/_data", {"pubs":pubs,"years":years,"daterange":daterange,"combined":combined,"ID":selectID,"dir":dir,"dID":dID, "order":order,"tolerance":tolerance}, function (data) {
		data = data['data'];
