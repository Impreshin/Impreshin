...
class reports_marketer_figures extends data {
...
//		test_array(array("old"=> $settings,"new"=>$values));
		...
		$years = ($y);;
		$where = "checked = '1' AND marketerID = '$marketerID' ";
		...
		$where = "ab_bookings.pID in ($publications) AND year(publishDate) in ($yearsSend_str) AND checked = '1' AND marketerID = '$marketerID' ";
