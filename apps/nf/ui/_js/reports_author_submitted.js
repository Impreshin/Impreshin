...
$(document).ready(function () {
	...
	$(document).on("reset", "#settings-modal form", function (e) {
		...
		if (confirm("Are you sure you want to reset all these settings?")) {
			...
			$.post("/app/nf/save/list_settings/?section=reports_author_submitted&reset=columns,group,order", function () {
	...
	$(document).on("submit", "#settings-modal form", function (e) {
		...
		$("#settings-modal").addClass("loading");
		$.post("/app/nf/save/list_settings/?section=reports_author_submitted", {"columns":columns, "group":group, "groupOrder":order}, function () {
...
function getData() {
	...
	$.getData("/app/nf/reports/data/author_submitted/_data", {"pubs":pubs, "years":years, "daterange":daterange, "combined":combined, "ID":ID, "dID":dID, "order":order, "tolerance":tolerance,"ym":ym, "group": group, "groupOrder": groupOrder}, function (data) {
