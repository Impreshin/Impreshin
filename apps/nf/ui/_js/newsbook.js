...
function getList(settings) {
	...
	$.getData("/app/nf/data/newsbook/_list", {"group": group, "groupOrder": groupOrder, "highlight": highlight, "filter": filter, "order": order, "search": search, "stageID": stageID}, function (data) {
