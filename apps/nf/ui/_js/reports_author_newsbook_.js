...
function getData() {
	...
	$.getData("/app/nf/reports/data/author_newsbook/_data", {"pubs":pubs, "years":years, "daterange":daterange, "combined":combined, "ID":ID, "dID":dID, "order":order, "tolerance":tolerance}, function (data) {
