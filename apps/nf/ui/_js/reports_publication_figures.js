...
$(document).ready(function () {
	...
	$(document).on("reset", "#settings-modal form", function (e) {
		...
		if (confirm("Are you sure you want to reset all these settings?")) {
			...
			$.post("/app/nf/save/list_settings/?section=reports_publication_figures&reset=columns,group,order", function () {
	...
	$(document).on("submit", "#settings-modal form", function (e) {
		...
		$("#settings-modal").addClass("loading");
		$.post("/app/nf/save/list_settings/?section=reports_publication_figures", {"columns":columns, "group":group, "groupOrder":order}, function () {
...
function getData() {
	...
	$.getData("/app/nf/reports/data/publication_figures/_data", {"pubs":pubs, "years":years, "daterange":daterange, "combined":combined, "ID":ID, "dID":dID, "order":order, "tolerance":tolerance, "group": group, "groupOrder": groupOrder, "filter": filter }, function (data) {
