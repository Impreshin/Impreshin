...
$(document).ready(function () {
	...
	$(document).on("reset", "#settings-modal form", function (e) {
		...
		if (confirm("Are you sure you want to reset all these settings?")) {
			...
			$.post("/app/nf/save/list_settings/?section=reports_category_figures&reset=columns,group,order", function () {
	...
	$(document).on("submit", "#settings-modal form", function (e) {
		...
		$("#settings-modal").addClass("loading");
		$.post("/app/nf/save/list_settings/?section=reports_category_figures", {"columns":columns, "group":group, "groupOrder":order}, function () {
