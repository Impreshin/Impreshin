...
class records_archives extends data {
	...
	//	test_array($values); 
		...
		//$where = "1";
		$where .= " AND (archived != '1') AND (nf_articles.rejected !='1' || authorID='$userID')";
		$options = array();
		if ($highlight=="used"){
		...
		//test_array(array($highlight,$filter)); 
