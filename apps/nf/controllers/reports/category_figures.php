...
use \timer as timer;
use \apps\nf\models as models;
class category_figures extends \apps\nf\controllers\_ {
	...
	function page() {
		...
		$list = models\categories::getAll("cID = '$cID'", "orderby ASC");
		...
		$tmpl->page = array(
			...
			"template"=> "reports_category_figures",
			"meta"    => array(
				"title"=> "NF - Reports - Category figures",
			)
		);
