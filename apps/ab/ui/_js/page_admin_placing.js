...
$(document).ready(function () {
	...
	$(document).on("click", "#btn-log", function (e) {
		...
		logsRequest.push($.getJSON("/app/ab/logs/placing", {}, function (data) {
			data = data['data'];
...
function getList() {
	...
	listRequest.push($.getJSON("/app/ab/data/admin_placing/_list", {"order":order}, function (data) {
		data = data['data'];
...
function getDetails() {
	...
	detailsRequest.push($.getJSON("/app/ab/data/admin_placing/_details", {"ID":ID}, function (data) {
		data = data['data'];
