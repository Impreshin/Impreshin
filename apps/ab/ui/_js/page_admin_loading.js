...
$(document).ready(function () {
	...
	$(document).on("click", "#btn-log", function (e) {
		...
		$.getData("/app/ab/logs/loading", {}, function (data) {
...
function getList() {
	...
	$("#right-area .loadingmask").show();
	$.getData("/app/ab/data/admin_loading/_list", {"order":order}, function (data) {
...
function getDetails() {
	...
	$.getData("/app/ab/data/admin_loading/_details", {"ID":ID}, function (data) {
