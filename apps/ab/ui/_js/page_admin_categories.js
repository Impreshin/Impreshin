...
$(document).ready(function () {
	...
	$(document).on("click", "#btn-log", function (e) {
		...
		$.getData("/app/ab/logs/categories", {}, function (data) {
...
function getList() {
	...
	$.getData("/app/ab/data/admin_categories/_list", {"order":order}, function (data) {
...
function getDetails() {
	...
	$.getData("/app/ab/data/admin_categories/_details", {"ID":ID}, function (data) {
