...
function getList(settings) {
	...
	listRequest.push($.getJSON("/app/ab/data/deleted/_list",{"group": group,"groupOrder":groupOrder, "highlight": highlight, "filter": filter, "order": order,"search":search,"dates":dates,"page":page},function(data){
		data = data['data'];
