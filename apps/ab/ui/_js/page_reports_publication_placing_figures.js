...
function getData() {
	...
	listRequest.push($.getJSON("/app/ab/data/reports/publication_placing_figures/_data", {"pubs":pubs, "years":years, "daterange":daterange, "combined":combined, "ID":ID, "dID":dID, "order":order, "tolerance":tolerance}, function (data) {
		data = data['data'];
