...
function getData() {
	...
	$.getData("/app/ab/data/reports/production_figures/_data", {"pubs":pubs, "years":years, "daterange":daterange, "combined":combined, "ID":ID, "dID":dID, "order":order, "tolerance":tolerance}, function (data) {
