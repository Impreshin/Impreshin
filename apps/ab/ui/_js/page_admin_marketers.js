...
$(document).ready(function () {
	...
	$(document).on("click", "#btn-log", function (e) {
		...
		$.getData("/app/ab/logs/marketers", {}, function (data) {
...
function getList() {
	...
	$.getData("/app/ab/data/admin_marketers/_list", {"order":order}, function (data) {
...
function getDetails() {
	...
	$.getData("/app/ab/data/admin_marketers/_details", {"ID":ID}, function (data) {
