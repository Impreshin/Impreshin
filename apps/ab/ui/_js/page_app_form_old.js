...
$(document).ready(function () {
	...
	$(document).on("submit", "#modal-delete form", function (e) {
		...
		if ($("#delete_reason").val() == "") {
			...
			$.post("/app/ab/save/bookings/booking_delete/?ID=" + $("#record-ID").val(), data, function (r) {
...
function form_submit() {
	...
	if (submit) {
		...
		$.post("/app/ab/save/bookings/form?ID=" + details['ID'] + "&type=" + type, data, function (response) {
