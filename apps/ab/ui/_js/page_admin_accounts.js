...
$(document).ready(function () {
	...
	$(document).on("click", "#btn-log", function (e) {
		...
		$.getData("/app/ab/logs/accounts", function (data) {
...
function getList() {
	...
	$.getData("/app/ab/data/admin_accounts/_list", {"page":page, "nr":records, "search":search, "statusID":statusID, "order":order}, function (data) {
...
function getDetails() {
	...
	$.getData("/app/ab/data/admin_accounts/_details", {"ID":ID}, function (data) {
